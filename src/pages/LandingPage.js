...
function LandingPage() {
    return (
        <>
            ...
            <div className="flex flex-col items-center justify-between min-h-screen p-5 space-y-6"> 
                <h1 className="text-left text-white text-5xl font-bold shadow-lg" tabIndex="0">
                ...
                <p className="text-left text-white text-lg" aria-label="Description of the service">
